...
public class otherbuilding extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View view = inflater.inflate(R.layout.fragment_otherbuilding, container, false);
        recyclerView = view.findViewById(R.id.recycleviewother);
        room_class rooms = new room_class();
        rooms.displayRoom(recyclerView,"Other Building",getContext());
      return view;
    }
}